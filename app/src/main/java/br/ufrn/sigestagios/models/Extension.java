...
public class Extension extends Offer implements Serializable {
    ...
    public Extension(String description, String term, int idTerm, String email, int year, int cpf_cnpj, String responsible, int positionsRemunerated, int idProject, int idProjectExtension) {
